      ...
      <div class="m-select-material" v-if="isShow">
        ...
        <div class="m-content">
          ...
          <div class="ui-material-wrap">
            <div class="ui-material-content">
              <div
                ...
                :class="[
                  item.select ? 'select' : '',
                  playInfo.key == 'dunhuang-game3' ? 'ui-w' : '',
                ]"
          ...
          <div class="m-have-select">
            ...
            <div
              class="btn btn-linear complate-btn"
              :class="{
                'btn-disabled':
                  (userSelectList.length < multipleChoiceNum) &
                  (playInfo.key != 'dunhuang-game2'),
              }"
              @click="onSynthesis"
            >
              {{ btnTxt }}
...
export default {
  ...
  methods: {
    show(materialInfo, playInfo) {
      ...
      if (playInfo.key == "dunhuang-game2") {
        this.btnTxt = "完成";
    ...
    onSynthesis() {
      if (
        ...
        this.playInfo.key == "dunhuang-game2"
      ) {
...
.m-content {
  ...
  .icon-close {
    width: 40px;
    height: 40px;
    background: url("//static.theone.art/pc/tom/icon-close.png")
      no-repeat center;
...
.m-material-card {
  ...
  .info {
    ...
    .select-icon {
      ...
      bottom: -2px;
      right: -2px;
      background: url("//static.theone.art/pc/tom/icon-selected.png")
        no-repeat center;
      background-size: contain;
    }
    .txt {
...
.m-have-select {
  ...
  .bar {
    ...
    .icon-delete {
      background: url("//static.theone.art/pc/tom/icon-close-black.png")
        no-repeat center;
      background-size: contain;
      display: inline-block;
      width: 19px;
