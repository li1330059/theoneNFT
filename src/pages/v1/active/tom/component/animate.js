...
function composeAnimate() {
    ...
    const colors = [
        { front: "#E2B57F", back: "#b37d38" }, // Purple
        { front: "#E2B57F", back: "#b37d38" }, // Light Blue
        { front: "#E2B57F", back: "#b37d38" }, // Darker Blue
    ];
