...
<template>
  <div>
    <transition name="fade">
      <div class="m-select-material synthesis-base-color" v-if="isShow">
        <div class="mask" />
        <div
          class="m-content synthesis-content-bg-img synthesis-dialog-content-bgcolor"
        >
          <div class="icon-close synthesis-select-close" @click="hide" />
          ...
          <div class="ui-material-wrap">
            <div class="ui-material-content">
              ...
              >
                <div class="content synthesis-select-border-color">
                  <div class="img-wrap">
                    <div
                      class="img-cover"
                  ...
                  <div class="info">
                    ...
                    <div class="synthesis-select-icon"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="m-have-select">
            ...
            <div class="select-wrap">
              ...
              >
                ...
                <span class="icon-delete synthesis-select-close" />
              </div>
            </div>
            <div
