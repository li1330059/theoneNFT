<template>
  <div class="log-body" v-if="isShow">
    <div class="mask"></div>
    <div class="dialog-content active-blind-box-dialog-bg-color">
      <div class="icon-close iconfont icon-icon_quxiao" @click="hide"></div>
      <div class="log-title">
        <div class="title">开启记录</div>
      </div>
      <div class="logs-list-wrap">
        <div
          class="list-bar list-title log-title-bgcolor log-title-color active-blind-box-log-title-bg-color active-blind-box-log-title-color"
        >
          <div class="td number">序号</div>
          <div class="td">开启时间</div>
          <div class="td">消耗物品</div>
          <div class="td">开启物品</div>
        </div>
        <div
          class="list-body"
      ...
      <div
        class="btn-red ui-btn log-btn-bgcolor log-btn-color active-blind-box-dialog-btn-bg-color active-blind-box-dialog-btn-color"
        @click="hide"
      >
        确定
      </div>
