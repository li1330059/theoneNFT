  ...
  <div>
    <div class="ui-body">
      ...
      <div class="material grayscale">
          ...
          <div class="content">
            <div class="content-top">
              ...
              <div class="content-lead color">
                <p>
                  每8个动漫二次元馆内的任意数字藏品，即可消耗合成1个联动盲盒。
                </p>
              </div>
            </div>
          </div>
        ...
        <div v-else>
          <div class="empty-wrap">活动尚未开始</div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      materialArr: [
        {
          img: "https://static.theone.art/pc/active/compose/goods-1.png",
          title: "8个动漫二次元馆内的数字藏品",
          uuid: null,
          value1: null,
          selectNum: 0,
          btnText: "去选择",
...
.ui-body {
  ...
  .linkage {
    .linkage-bg {
      ...
      background: url("//static.theone.art/pc/active/compose/result.png")
        no-repeat center;
  ...
  .icon {
    ...
    width: 0.64rem;
    height: 0.65rem;
    background: url("//static.theone.art/pc/active/compose/icon-p-bottom.png");
    background-size: contain;
    @media screen and (max-width: 540px) {
      margin: 0.39rem auto;
    }
...
.banner {
  width: 100%;
  height: 350px;
  background: url("https://static.theone.art/pc/active/compose/banner-1.png")
    no-repeat center;
  background-size: cover;
  background-position: 50%;
  @media screen and (max-width: 540px) {
