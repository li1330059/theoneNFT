...
require("../../../utils/gt4");
export default {
  components: { getphonecode, Header, Content },
  name: "login",
  data() {
    return {
      loading: false,
        ...
        function (captchaObj) {
          captchaObj
            ...
            .onSuccess(function () {
              ...
              self.$store.commit("setGeetestParams", successRes);
              self.$api.service.test_behaviorVerify();
            })
        ...
        switch (this.login_way) {
          case "phone":
            if (this.$route.query.code) {
              params.inviteCode = this.$route.query.code;
            }
