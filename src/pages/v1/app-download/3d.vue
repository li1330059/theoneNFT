<template>
  <div class="ui-body">
    <div class="m-info">
      ...
      <img
        class="title responsive-img"
        src="//static.theone.art/pc/app-download/3d/t1.png"
      />
      <div class="ui-banner mobile-banner">
        <img
          class="responsive-img"
          src="//static.theone.art/pc/app-download/3d/banner.png"
        />
      </div>
      <div class="btn-group">
        ...
        <div class="btn" @click="download('ios')">
          ...
          <div class="code-wrap">
            ...
            <img
              class="responsive-img"
              :src="`//static.theone.art/pc/app-download/ios-app.png?tiemr=${new Date().getTime()}`"
            />
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async getConfig() {
      let result = await this.$api.service.appVersion_judgeAppVersion(
        {},
        null,
        "",
        {
      ...
      if (result && result.data.code == 200) {
        ...
        new QRCode("qrcode", {
          width: 122,
          height: 122,
          text: this.configInfo.appUrl,
        });
      }
    },
    download(type) {
      if (type == "android") {
        window.location.href = this.configInfo.appUrl;
      } else {
        if (this.$common.isMobile()) {
          window.location.href = `https://apps.apple.com/cn/app/%E5%94%AF%E4%B8%80%E8%89%BA%E6%9C%AF/id1628464773`;
        } else {
        }
      }
    },
...
.ui-body {
  background: url("//static.theone.art/pc/app-download/3d/bg.png") no-repeat
    center;
