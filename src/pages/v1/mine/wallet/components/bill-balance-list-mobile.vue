  ...
  <div class="ui-wrap">
    ...
    >
      <div class="line-bar">
        <div>
          <div class="txt">
            <div v-if="item.dataType == 1"> 售出-{{ item.consignmentInfo && item.consignmentInfo.name }}</div>
        ...
        <div>
          <div class="yellow-num" v-if="item.operateType == 1">
            + {{ $common.formatMoney(item.amount) }}
          </div>
          <div class="red-num" v-if="item.operateType == 2">
            - {{ $common.formatMoney(item.amount) }}
          </div>
        </div>
      </div>
      <div class="line-bar">
        ...
        <div>
          <div class="txt">
            <div>{{ $common.formatMoney(item.amountOld) }}</div>
          </div>
        </div>
      </div>
      <div class="line-bar">
        ...
        <div>
          <div class="txt">
            <div>{{ $common.formatMoney(item.amountNew) }}</div>
          </div>
        </div>
      </div>
      <div class="line-bar">
