        ...
        <div class="input-line">
          <div class="draw-input">
            <el-input
              ...
              maxlength="8"
              :placeholder="amount > 0 ? amount : 0"
            >
              <span slot="prefix" class="el-input__icon">¥</span></el-input
            >
            <span class="sign-btn hand" @click="inputAll">全部提现</span>
          </div>
        </div>
...
export default {
  ...
  methods: {
    inputAll() {
      this.withdrawalAmountParam.amount = this.amount;
    },
    async init(param) {
